    ...
    return (
            <div className="box">
                <div className="firstTab">
                    <ul>
                        <li>
                            {" "}
                            <img
                                src="https://o.remove.bg/downloads/595ec232-afd8-4232-8fae-05b8b6799361/Visual_Studio_Code_1.35_icon.svg-removebg-preview.png"
                                alt="VS"
                            />{" "}
                        </li>
                        <li>File</li>
                ...
                <div className="proyectName">
                    <h1>
                        {" "}
                        TomasVallejos.js - vs_portfolio - Visual Studio Code
                    </h1>
                </div>
